    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prev_revision', models.CharField(max_length=1, verbose_name='Revisión')),
                ('prev_estado_cliente', models.IntegerField(blank=True, choices=[('', '---'), (1, 'Aprobado con Comentarios'), (2, 'Rechazado'), (3, 'Eliminado'), (4, 'Aprobado'), (5, 'Valido para construcción'), (6, 'Aprobado (en numeracion)')])),
                ('prev_estado_contratista', models.IntegerField(blank=True, choices=[('', '---'), (1, 'Para revisión'), (2, 'Para aprobación')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comentario', models.FileField(blank=True, default=None, null=True, upload_to='proyecto/comentarios/')),
                ('archivo', models.FileField(blank=True, default=None, null=True, upload_to='proyecto/documentos/')),
                ('revision', models.CharField(blank=True, default=None, max_length=1, null=True, verbose_name='Revisión')),
                ('estado_cliente', models.IntegerField(blank=True, choices=[('', '---'), (1, 'Aprobado con Comentarios'), (2, 'Rechazado'), (3, 'Eliminado'), (4, 'Aprobado'), (5, 'Valido para construcción'), (6, 'Aprobado (en numeracion)')], default=None, null=True)),
                ('estado_contratista', models.IntegerField(blank=True, choices=[('', '---'), (1, 'Para revisión'), (2, 'Para aprobación')], default=None, null=True)),
                ('documento_fk', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='panel_carga.documento')),
                ('owner', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Creador')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asunto', models.CharField(blank=True, default=None, max_length=50, null=True, verbose_name='Asunto')),
                ('descripcion', models.CharField(blank=True, default=None, max_length=200, null=True, verbose_name='Descripción')),
                ('destinatario', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='destinatario_borrador', to=settings.AUTH_USER_MODEL)),
                ...
                ('version', models.ManyToManyField(blank=True, default=None, through='bandeja_es.BorradorDocumento', to='bandeja_es.BorradorVersion')),
            ],
        ),
        migrations.AddField(
