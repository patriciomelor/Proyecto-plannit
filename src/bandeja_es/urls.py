...
urlpatterns = [
    ...
    path('version/nuevo/<paquete_pk>/', views.PrevVersionView.as_view(), name='nueva-version'),
    path('version/popup/<paquete_pk>/', views.TablaPopupView.as_view(), name='popup-version'),
